...
int main(int argc, char **argv)
{
    ...
    while (1)
    {
        ...
        double inf_time_ms = duration.count() / 1000.0;
        ...
        // Show Inference Time
        ostringstream oss;
        oss << fixed << setprecision(2) << inf_time_ms;
        string inf_time = oss.str() + " ms DPU";
        putText(img, inf_time, Point(50, 80), cv::FONT_HERSHEY_DUPLEX, 1.0, CV_RGB(255, 0, 0), 2);
